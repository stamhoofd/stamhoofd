        ...
        <main class="center">
            ...
            <STList class="illustration-list">
                ...
                <STListItem :selectable="true" class="left-center" @click="$navigate(Routes.RegistrationPeriods)">
                    <template #left>
                        <img src="@stamhoofd/assets/images/illustrations/calendar.svg"></template>
                    <h2 class="style-title-list">
                ...
                <STListItem :selectable="true" class="left-center" @click="$navigate(Routes.PlatformMembershipTypes)">
                    <template #left>
                        <img src="@stamhoofd/assets/images/illustrations/membership.svg"></template>
                    <h2 class="style-title-list">
                ...
                <STListItem :selectable="true" class="left-center" @click="$navigate(Routes.EventTypes)">
                    <template #left>
                        <img src="@stamhoofd/assets/images/illustrations/tent.svg"></template>
                    <h2 class="style-title-list">
                ...
                <STListItem v-if="$feature('event-notifications')" :selectable="true" class="left-center" @click="$navigate(Routes.EventNotificationTypes)">
                    <template #left>
                        <img src="@stamhoofd/assets/images/illustrations/event-notifications.svg"></template>
                    <h2 class="style-title-list">
            ...
            <hr><h2>{{ $t('f57428fb-a76c-4d1a-a5be-ef0d015194b1') }}</h2>
            ...
            <STList class="illustration-list">
                <STListItem :selectable="true" class="left-center" @click="$navigate(Routes.EmailSettings)">
                    ...
                    <p class="style-description">
                        {{ $t('af9c1654-8d21-4984-b032-cbccceb02f50') }}
                    </p>
                    <template #right>
                        <span class="icon arrow-right-small gray"/>
                    </template>
            ...
            <STList class="illustration-list">
                ...
                <STListItem v-if="platform.config.loginMethods.has(LoginMethod.Google)" :selectable="true" class="left-center" @click="$navigate(Routes.SingleSignOn, { properties: {provider: LoginProviderType.Google} })">
                    <template #left>
                        <img src="@stamhoofd/assets/images/partners/google/google-50.svg"></template>
                    <h2 class="style-title-list">
                        {{ $t('3b795df6-9534-42f7-94b7-98bfe8e45831') }}
                    </h2>
                    <p class="style-description">
                        {{ $t('4e3bb57e-b82c-4007-adb4-77965bc24a18') }}
                    </p>
                    <template #right>
                        <span class="icon arrow-right-small gray"/>
                    </template>
