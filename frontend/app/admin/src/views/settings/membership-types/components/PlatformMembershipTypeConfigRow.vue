<template>
    <STListItem :selectable="true" class="right-stack">
        ...
        <template #right>
            <span v-if="config.prices[0] && type.behaviour === PlatformMembershipTypeBehaviour.Days" class="style-description-small">{{ formatPrice(config.prices[0].pricePerDay) }} {{ $t('%I8') }}</span>
