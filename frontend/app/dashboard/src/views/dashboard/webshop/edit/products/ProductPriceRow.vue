...
function editPrice() {
    present(AsyncComponent(() => import('./EditProductPriceView.vue'), { product: props.product, productPrice: props.productPrice, isNew: false, saveHandler: (patch: AutoEncoderPatchType<Product>) => {
        emits('patch', patch);
