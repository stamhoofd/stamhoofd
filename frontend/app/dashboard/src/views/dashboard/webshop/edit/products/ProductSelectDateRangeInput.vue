    ...
    <div>
        <STList v-if="dateRanges.length > 0">
            ...
            <STListItem element-name="label" :selectable="true" class="left-center">
                ...
                {{ $t('Een andere datum/tijdstip') }}
            </STListItem>
        </STList>
        <p v-if="editingDateRange" class="warning-box">
            {{ $t("Opgelet, alle tickets die deze datum/tijdstip hadden zullen worden gewijzigd. Kies 'Een andere datum/tijdstip' als je een nieuwe datum wilt invoeren.") }}
        </p>
