...
async function deleteMe() {
    if (!await CenteredMessage.confirm({
        title: name.value ? $t('‘{name}’ verwijderen?', { name: name.value }) : $t('Deze vraag verwijderen?'),
        confirmText: 'Verwijderen',
        description: $t('De vraag wordt pas echt verwijderd als je verder gaat en alle wijzigingen opslaat.'),
