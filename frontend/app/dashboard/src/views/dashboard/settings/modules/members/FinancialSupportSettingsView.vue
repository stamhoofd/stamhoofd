    ...
    <div id="financial-support-settings-view" class="st-view background">
        ...
        <main>
            ...
            <template v-if="enableFinancialSupport">
                ...
                <p>Als een lid gebruik wil maken van de financiële ondersteuning, dan tonen we dit als waarschuwing als je dat lid bekijkt in Stamhoofd. Je kan zelf de tekst in deze waarschuwing wijzigen. Dit is ook zichtbaar voor de leden zelf.</p>
