...
import { CenteredMessage, ContextMenu, ContextMenuItem, useAuth, useEmitPatch, usePatchMoveUpDownSingleIds } from '@stamhoofd/components';
...
const { up, down } = usePatchMoveUpDownSingleIds(props.category.id, computed(() => parentCategory.value.categoryIds), (categoryIds) => {
