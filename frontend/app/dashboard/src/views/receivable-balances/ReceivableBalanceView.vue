<template>
    <LoadingViewTransition>
        <div class="st-view" v-if="detailedItem">
...
import { BalancePriceBreakdown, GlobalEventBus, GroupedBalanceList, LoadingViewTransition, PaymentRow, SegmentedControl, useBackForward, useContext } from '@stamhoofd/components';
