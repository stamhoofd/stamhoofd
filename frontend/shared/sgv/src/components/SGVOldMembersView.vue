...
import type { SGVLid } from '@stamhoofd/sgv';
...
function setActionWrapper(action: SGVOldMemberAction) {
...
function doDelete() {
    setActionWrapper(SGVOldMemberAction.Delete);
}
function doNothing() {
    setActionWrapper(SGVOldMemberAction.Nothing);
}
