<template>
    ...
    <button v-else v-long-press="($event: MouseEvent) => open($event)" class="organization-switcher" data-testid="org-switcher" :class="{small}" type="button" @click="open" @contextmenu.prevent="open($event)">
