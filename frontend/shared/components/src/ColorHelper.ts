...
export class ColorHelper {
    ...
    static setupDarkTheme() {
        ...
        //s = preferredS
        //h = preferredH
        document.documentElement.style.setProperty("--dark-theme-color-gray-1", gray)
        ...
        document.documentElement.style.setProperty("--dark-theme-color-gray-4", darkGray)
        ...
        document.documentElement.style.setProperty("--dark-theme-color-gray-2", grayLight)
        ...
        document.documentElement.style.setProperty("--dark-theme-color-gray-3", grayLighter)
