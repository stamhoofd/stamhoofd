-- description: Eén rij per lid per eenheid voor het gekozen werkjaar: de inschrijving die voor het lid spreekt. Een leeftijdsgroep wint van een activiteit, leiding wint van lid, en de oudste leeftijdsgroep wint bij twee.
