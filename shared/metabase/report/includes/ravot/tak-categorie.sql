...
CASE dag.id
    -- Kinderen
    WHEN 'bd63a6ef-d4a1-497d-87a5-d7c36b4ad220' THEN 'child'   -- Leeuwkes, Kabouters en Sloebers (6-8)
    WHEN '23607074-624b-472f-926f-c719bb44e314' THEN 'child'   -- Springers en Pagadders (8-10)
    WHEN '5730f613-fb72-465b-b902-45b281a0e8b8' THEN 'child'   -- Jongknapen, Roodkapjes en Joro's (10-12)
    WHEN '3d56a0b2-9f4b-46ac-998b-d45a9b64cab2' THEN 'child'   -- Knapen, Jimmers en Knimmers (12-14)
    WHEN '03680919-689c-4df1-8976-bb71758cc025' THEN 'child'   -- Sjo'ers, Simmers en Jonghernieuwers (14-16)
