...
-- there, nor in the omkaderingscijfer it subtracts, and a member whose date of birth is unknown has
-- no age and falls outside them the same way.
--
...
--
-- The omkaderingscijfer is the one from `omkaderingscijfer.sql` beside this, over the same kinderen
-- under seventeen, unrounded -- only what reaches the screen is rounded. A unit without leiding has
-- none, and NULLIF keeps the index null there rather than letting the charts draw a zero.
ROUND(
