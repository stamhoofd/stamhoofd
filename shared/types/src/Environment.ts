...
import type { LanguageMap } from './LanguageMap.js';
import type { Localized } from './Localized.js';
import type { MemberNumberAlgorithm } from './MemberNumberAlgorithm.js';
import type { StamhoofdDomains } from './StamhoofdDomains.js';
 ...
 */
export type BackendSpecificEnvironment = {
    // Database
...
export type BackendEnvironment = SharedEnvironment & BackendSpecificEnvironment;

/**
 * Environment only available in the frontend apps
 */
export type FrontendSpecificEnvironment = {
 ...
 * The environment that is available everywhere: frontend, backend and shared
 */
export type RedirecterEnvironment = {
    /**
     * We'll map the value of NODE_ENV to the corresponsing value. But staging value isn't valid for NODE_ENV, hence our own variable
     */
    readonly environment: 'production' | 'development' | 'staging' | 'test';
...
export type FrontendEnvironment = SharedEnvironment & FrontendSpecificEnvironment;
