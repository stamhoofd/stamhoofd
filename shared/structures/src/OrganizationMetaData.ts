...
export class OrganizationMetaData extends AutoEncoder {
    ...
    @field({ decoder: new EnumDecoder(UitpasClientCredentialsStatus), ...NextVersion, defaultValue: () => UitpasClientCredentialsStatus.NOT_CONFIGURED})
    uitpasClientCredentialsStatus: UitpasClientCredentialsStatus = UitpasClientCredentialsStatus.NOT_CONFIGURED;
