...
export type MemberPropertyWithFilter = Exclude<MemberProperty, 'dataPermission' | 'financialSupport' | 'taxDependent' | 'parents.nationalRegisterNumber' | 'parents.taxDependent'>;
/**
