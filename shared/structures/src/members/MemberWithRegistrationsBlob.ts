...
export class MemberWithRegistrationsBlob extends Member implements Filterable {
    ...
    getGroups(organization: Organization): Group[] {
    ...
    /**
     * Returns whether SGV should manage this member because they have an active
     * membership registration.
     * */
    isSGVManagedMember(groups?: Group[]): boolean {
        // TODO improve
