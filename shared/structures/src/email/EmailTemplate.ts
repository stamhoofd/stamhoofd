...
export class EmailTemplate extends AutoEncoder {
    ...
    static getTypeTitle(type: EmailTemplateType): string {
        switch (type) {
            ...
            case EmailTemplateType.SavedPaymentsEmail: return $t('a658e92f-44f5-466c-b4cd-bd584ee6eec4');
            ...
            case EmailTemplateType.DefaultPaymentsEmail: return $t('d9fd4e85-de83-4e1d-99a8-0ef8d56a9baf');
    ...
    static getTypeDescription(type: EmailTemplateType): string {
        switch (type) {
            ...
            case EmailTemplateType.DefaultPaymentsEmail: return $t('6384dd23-fe44-41a9-b86f-051ab7709e4d');
