...
export type StamhoofdKeyFilterValue = {$eq: StamhoofdCompareValue}|{$in: StamhoofdCompareValue[]}|{$neq: StamhoofdCompareValue}|{$gt: StamhoofdCompareValue}|{$lt: StamhoofdCompareValue}|{$contains: string}|StamhoofdFilter;
