...
describe("Endpoint.GetOrganizationPayments", () => {
    // Test endpoint
    const endpoint = new GetOrganizationPaymentsEndpoint();

    test("Request payments", async () => {
        ...
        const r = Request.buildJson("GET", "/v6/organization/payments", organization.getApiHost());
