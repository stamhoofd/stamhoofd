...
1. We use `yarn`. Do not use `npm`. That will break things. Use `yarn policies set-version 1.22.5` to set the version of yarn to the one used in the project (and the server). Replace 1.22.5 with the version in package.json > engines > yarn
