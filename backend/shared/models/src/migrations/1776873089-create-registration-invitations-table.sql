CREATE TABLE `registration_invitations` (
	...
	`autoRemoveFromWaitingListWithId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
	...
	CONSTRAINT `registration_invitations_ibfk_4` FOREIGN KEY (`autoRemoveFromWaitingListWithId`) REFERENCES `groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
