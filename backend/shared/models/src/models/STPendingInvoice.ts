    ...
    static async charge(organization: Organization) {
        ...
        if (price <= 0) {
            ...
            const molliePayment = await mollieClient.payments.create({
                ...
                mandateId: organization.serverMeta.mollieMandateId ?? undefined,
