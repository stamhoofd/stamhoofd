...
import { Address, Country,DNSRecordStatus, EmailTemplateType, Group as GroupStruct, GroupStatus, Organization as OrganizationStruct, OrganizationEmail, OrganizationMetaData, OrganizationPrivateMetaData, OrganizationRecordsConfiguration, PaymentMethod, PaymentProvider, PermissionLevel, Permissions, PrivatePaymentConfiguration, Recipient, Replacement, STPackageType, TransferSettings, WebshopPreview } from "@stamhoofd/structures";
...
export class Organization extends Model {
    ...
    async _getPrivateStructure(user?: UserWithOrganization): Promise<OrganizationStruct> {
        ...
        return OrganizationStruct.create({
            ...
            uri: this.uri,
            website: this.website,
            groups: groups.map(g => g._getPrivateStructure(user)).sort(GroupStruct.defaultSort),
