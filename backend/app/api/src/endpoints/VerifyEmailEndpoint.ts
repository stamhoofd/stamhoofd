    ...
    async handle(request: DecodedRequest<Params, Query, Body>) {
        ...
        if (!code) {
            throw new SimpleError({
                ...
                human: "Deze code is ongeldig of vervallen. Probeer om opnieuw in te loggen om een nieuwe code te versturen. Let op dat je niet te veel verificatie e-mails tergelijk verstuurt, want dan is de kans klein dat je de juiste code zal ingeven.",
                statusCode: 400
            })
        }
