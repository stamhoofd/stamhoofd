...
export class SetUitpasClientCredentialsEndpoint extends Endpoint<Params, Query, Body, ResponseBody> {
    ...
    async handle(request: DecodedRequest<Params, Query, Body>) {
        ...
        if (request.body.clientId === '' && request.body.clientSecret === '') {
            ...
            organization.meta.uitpasClientCredentialsStatus = UitpasClientCredentialsStatus.NOT_CONFIGURED;
            await organization.save();
            const resp = new UitpasSetClientCredentialsResponse();
            resp.status = UitpasClientCredentialsStatus.NOT_CONFIGURED;
        ...
        organization.meta.uitpasClientCredentialsStatus = UitpasClientCredentialsStatus.NOT_CHECKED;
        await organization.save();
