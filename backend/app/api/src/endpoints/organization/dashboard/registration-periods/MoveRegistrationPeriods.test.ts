...
import { Group, GroupType, OrganizationRegistrationPeriod as OrganizationRegistrationPeriodStruct, PermissionLevel, Permissions, Version } from '@stamhoofd/structures';
...
describe('Endpoint.PatchOrganizationRegistrationPeriodsEndpoint', () => {
    ...
    describe('Move group to other period', () => {
        ...
        test('Move group to period if no waiting list should work', async () => {
            const group = await new GroupFactory({ organization }).create();
