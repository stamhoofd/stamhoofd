...
import { StartOrganizationRegistrationPeriodsEndpoint } from './StartOrganizationRegistrationPeriodsEndpoint.js';

const endpoint = new StartOrganizationRegistrationPeriodsEndpoint();
