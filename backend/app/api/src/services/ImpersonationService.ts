...
import { AuditLog, ImpersonationToken, Organization, Token, User } from '@stamhoofd/models';
 ...
 * administrator and every access check is made for both accounts (see Token and
...
export class ImpersonationService {
    ...
    static async redeemTicket(ticket: string): Promise<Token> {
        ...
        const token = await Token.createImpersonationToken(user, impersonatedUser);
